...
<body>
	<form action="/sport" method="get">
		<table id="wijziglid">
			...
			<tr>
				<td>Achternaam</td>
				<td><input type="text" name="achternaam" value="${lid.roepnaam}"></td>
			</tr>
			<tr>
				<td>Adres</td>
			...
			<tr>
				<td>Geslacht</td>
				<c:choose>
					<c:when test="${lid.geslacht == 'man'} || ${lid.geslacht == null }">
		...
		<input type="hidden" name="spelerscode" value="${lid.spelerscode }"></td>
		<input type="submit" name="wijziglid" value="wijzig">
