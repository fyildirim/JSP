			...
			<table id="ledentabel">
				...
				<c:forEach var="lid" items="${admin.leden}">
					<tr>
			    		...
			    		<td> ${lid.geslacht}</td>
			    		<td><a href="/sport?spelerscode=${lid.spelerscode}&amp;lidwijzig=+">wijzig<a/></td>
	 		        	<td><a href="/sport?spelerscode=${lid.spelerscode}&amp;lidverwijder=+">verwijder<a/></td>
	 		        	<td><a href="/sport?spelerscode=${lid.spelerscode}&amp;lidteams=+">Teams<a/></td>
			    	</tr>
				</c:forEach>
			</table>
			...
			<table id="teamlijst">
				...
				<c:forEach var="team" items="${admin.teams}">
					<tr>
						...
						<td><a href="/sport?teamcode=${team.teamcode}&amp;teamwijzig=+">wijzig<a/></td>
						<td><a href="/sport?teamcode=${team.teamcode}&amp;teamverwijder=+">verwijder<a/></td>
						<td><a href="/sport?teamcode=${team.teamcode}&amp;teamleden=+">leden<a/></td>
					</tr>
				</c:forEach>
			</table>
		</c:otherwise>
